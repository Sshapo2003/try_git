class Helpers::BasicAuthHelper
  class << self
    def authorize(session)
      ...
      ['wildfire_site_root', 'wildfire_messenger_root', 'wildfire_promotions_root', 'wildfire_page_manager_root', 'wildfire_analytics_root', 'wildfire_front_page'].each do |site|
