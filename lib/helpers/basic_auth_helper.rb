class Helpers::BasicAuthHelper
  class << self
    def authorize(session)
      ...
      %w{wildfire_site_root wildfire_messenger_root wildfire_promotions_root wildfire_page_manager_root wildfire_analytics_root wildfire_monitor_root}.each do |site|
