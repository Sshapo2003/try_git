class Model::Page::PageManager::WildfireappPageManager < SitePrism::Page
  ...
  section :published_pages_panel, Model::Section::PageManager::PagesPanel, '.body_content_wpr .inner_liner'
  section :draft_pages_panel, Model::Section::PageManager::PagesPanel, '.body_content_wpr .inner_liner'
  section :archived_pages_panel, Model::Section::PageManager::PagesPanel, '.body_content_wpr .inner_liner'
