@analytics @production @staging @amtest
Feature: Analytics Reports
  ...
  Scenario: View Each Report Type
    ...
    And the "Pages Overview" panel should be visible in the main page area on wildfire app analytics page
    ...
    And the "Overview of all Tabs" panel should be visible in the main page area on wildfire app analytics page
    ...
    And the "Posts Overview" panel should be visible in the main page area on wildfire app analytics page
