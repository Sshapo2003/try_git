...
Feature: Manage Companies
  ...
  Scenario: Create a new Company
    # Find out whether or not user should be taken to promo builder after creating the new company
    # Verify the new company becomes the current company in toolbar
    
  @not-started
  Scenario: Ensure Company name is unique for the Account
  
  @not-started
  Scenario: Create a new company under a new Account
    # Verify new account is displayed in the account/company dropdown list
